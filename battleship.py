...
if COMPUTER_GUESS == 1:
  print ("Computer guessed row: %d colu5mn: %d" % (ship_row,ship_col))
...
for attempt in range(NO_USER_GUESS):
  ...
  if guess_row == ship_row and guess_col == ship_col:
      ...
      if (guess_row < 0 or guess_row > 20) or (guess_col < 0 or guess_col > 60):
          print ("Oops, that's not even in the ocean.")
      elif(board[guess_row][guess_col] == "XXXXX"):
          print ("You guessed that one already!!!")
      else:
          print ("You missed my battleship!")
          board[guess_row][guess_col] = "XXXXX"
